...
class passenger::data {
  ...
  case $::operatingsystem {
    'darwin':{
      $passenger_bin_path = '/System/Library/Frameworks/Ruby.framework/Versions/Current/usr/bin'
